...
<body>
	<div class="container-fluid">
		...
		<div class="container margenRegistro">

			<form class="form-horizontal" action="insertarCliente" method="post">
				<fieldset>
					...
					<!-- Password input-->
					<div class="form-group">
						<label class="col-md-4 control-label" for="password">Contraseña
						</label>
						<div class="col-md-4">
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-md-4 control-label" for="direccion">DNI</label>
						<div class="col-md-4">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input id="telefono" name="telefono" type="text"
								placeholder="Telefono" class="form-control input-md" required="">
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="col-md-4 control-label" for="codigoPostal">Codigo
							Postal</label>
						<div class="col-md-2">
							<input id="codigoPostal" name="codigoPostal" type="text"
								placeholder="Codigo Postal" class="form-control input-md"
								required="">
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input id="direccion" name="direccion" type="text"
								placeholder="Dirección" class="form-control input-md"
								required="">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type=submit value="Registrar" id="registrar" name="registrar" class="btn btn-success">
						</div>
					</div>
				</fieldset>
			</form>
