	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-4"></div>
				<div class="col-md-4">
					<div class="thumbnail">
						<img style="width: 100%;" alt="${pelicula.titulo}" src="${pelicula.imagen}" class="img-rounded">
						<div class="caption">
							<p>
								<b>Sinópsis: </b>
							</p>
							...
							<p>
								<b>Director:</b> ${pelicula.director} <br> <b>Duración:</b>
								${pelicula.duracion} minutos <br> <b>Año:</b>
								${pelicula.year} <br> <b>Género: </b> ${pelicula.genero} <br>
								<b>Precio: </b> ${pelicula.precio}
							</p>
							<p>
