...
<body>
	<div class="container-fluid">
		...
		<div class="container margenRecibido">
			<div class="jumbotron">
				<h2><b>CineTic da solución a tus problemas</b></h2><hr>
				<h3>No se preocupe ${nombre}, le contestaremos lo más rapido posible</h3>
				<h4>Email: ${email}</h4>
				<h4>Telefono: ${telefono}</h4>
				<h4>Asunto: ${asunto}</h4>
				<h2>Gracias por confiar en Cinetic.</h2>
			</div>
		</div>
