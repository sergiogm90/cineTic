...
<body>
	<div class="container-fluid">
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="loginAdministrador.jsp"><span
		...
		<div class="btn-group btn-group-justified">
			<a href="listarPeliculas" class="btn btn-primary">Gestion Peliculas</a>
			<a href="listarClientes" class="btn btn-primary">Gestion Clientes</a>
		</div>
		<br>

		<div class="container-fluid margenRecibido">
			<div class="row">
				...
				<div class="col-md-12">
					...
					<table class="table">
						<thead>
							<tr>
								<th>Id</th>
								<th class="col-md-1 justificado">DNI</th>
								<th class="col-md-1 justificado">Nombre</th>
								<th class="col-md-1 justificado">Apellidos</th>
								<th class="col-md-5 justificado">Usuario</th>
								<th class="col-md-1 justificado">Contraseña</th>
								<th class="col-md-1 justificado">Dirección</th>
								<th class="col-md-1 justificado">CP</th>
								<th class="col-md-1 justificado">Telefono</th>
								<th class="col-md-1 justificado">Email</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<c:forEach var="cliente" items="${listaClientes}">
								<tr>
									...
									<td class="col-md-1 justificado">${cliente.dni}</td>
									<td class="col-md-1 justificado">${cliente.nombre}</td>
									<td class="col-md-1 justificado">${cliente.apellidos}</td>
									<td class="col-md-5 justificado">${cliente.usuario}</td>
									<td class="col-md-1 justificado">${cliente.password}</td>
									<td class="col-md-1 justificado">${cliente.direccion}</td>
									<td class="col-md-1 justificadojo">${cliente.codigoPostal}</td>
									<td class="col-md-1 justificado">${cliente.telefono}</td>
									<td class="col-md-1 justificadojo">${cliente.email}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
